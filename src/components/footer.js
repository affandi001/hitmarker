            ...
            <div className="container mx-auto pl-20 mt-8 pb-24">
                <div className="flex ">
                    ...
                    <div className="w-[20%]">
                        ...
                        <h1 className="pt-2 text-[#222831]">Low fare tips</h1>
                    </div>
                    ...
                    <div className="w-[20%] ">
                        ...
                        <div className="flex gap-x-2 mt-4">
                            <div className="flex px-2 border-2 border-[#2E2E46] rounded-2xl bg-[#2E2E46] ">
                                ...
                                <div className="text-[10px] px-2 text-white">
                                    <h1>GET IT ON</h1>
                                    <h1>Google Play</h1>
                                </div>
                            </div>
                            ...
                            <div className="flex px-2 border-2 border-[#2E2E46] rounded-2xl bg-[#2E2E46] ">
                                ...
                                <div className=" px-2 text-white">
                                    <h1 className="text-[7px]">AVAILABLE ON</h1>
                                    <h1 className="text-[10px]">Playstore</h1>
                                </div>
                            </div>
                        </div>
